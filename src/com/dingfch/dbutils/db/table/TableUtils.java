...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.dingfch.dbutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.dingfch.dbutils.db.table.Id>();

    /* package */
    static synchronized com.dingfch.dbutils.db.table.Id getId(Class<?> entityType) {
        ...
        com.dingfch.dbutils.db.table.Id id = new com.dingfch.dbutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.dingfch.dbutils.db.table.Id id = getId(entityType);
