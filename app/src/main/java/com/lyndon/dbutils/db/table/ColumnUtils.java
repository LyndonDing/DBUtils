...
package com.lyndon.dbutils.db.table;
...
import com.lyndon.dbutils.db.annotation.Check;
import com.lyndon.dbutils.db.annotation.Column;
import com.lyndon.dbutils.db.annotation.Finder;
import com.lyndon.dbutils.db.annotation.Foreign;
import com.lyndon.dbutils.db.annotation.Id;
import com.lyndon.dbutils.db.annotation.NotNull;
import com.lyndon.dbutils.db.annotation.Transient;
import com.lyndon.dbutils.db.annotation.Unique;
import com.lyndon.dbutils.db.converter.ColumnConverter;
import com.lyndon.dbutils.db.converter.ColumnConverterFactory;
import com.lyndon.dbutils.db.sqlite.FinderLazyLoader;
import com.lyndon.dbutils.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(com.lyndon.dbutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(com.lyndon.dbutils.db.table.Finder finderColumn) {
