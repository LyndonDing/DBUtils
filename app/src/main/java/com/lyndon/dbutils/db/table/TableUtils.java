...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.lyndon.dbutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.lyndon.dbutils.db.table.Id>();

    /* package */
    static synchronized com.lyndon.dbutils.db.table.Id getId(Class<?> entityType) {
        ...
        com.lyndon.dbutils.db.table.Id id = new com.lyndon.dbutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.lyndon.dbutils.db.table.Id id = getId(entityType);
