...
package cn.ly.dbutils.db.table;
...
import cn.ly.dbutils.db.annotation.Check;
import cn.ly.dbutils.db.annotation.Column;
import cn.ly.dbutils.db.annotation.Finder;
import cn.ly.dbutils.db.annotation.Foreign;
import cn.ly.dbutils.db.annotation.Id;
import cn.ly.dbutils.db.annotation.NotNull;
import cn.ly.dbutils.db.annotation.Transient;
import cn.ly.dbutils.db.annotation.Unique;
import cn.ly.dbutils.db.converter.ColumnConverter;
import cn.ly.dbutils.db.converter.ColumnConverterFactory;
import cn.ly.dbutils.db.sqlite.FinderLazyLoader;
import cn.ly.dbutils.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
    ...
    public static Class<?> getForeignEntityType(cn.ly.dbutils.db.table.Foreign foreignColumn) {
    ...
    @SuppressWarnings("unchecked")
    public static Class<?> getFinderTargetEntityType(cn.ly.dbutils.db.table.Finder finderColumn) {
