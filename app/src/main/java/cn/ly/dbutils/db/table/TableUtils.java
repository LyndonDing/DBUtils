...
import cn.ly.dbutils.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, cn.ly.dbutils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, cn.ly.dbutils.db.table.Id>();

    /* package */
    static synchronized cn.ly.dbutils.db.table.Id getId(Class<?> entityType) {
        ...
        cn.ly.dbutils.db.table.Id id = new cn.ly.dbutils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        cn.ly.dbutils.db.table.Id id = getId(entityType);
