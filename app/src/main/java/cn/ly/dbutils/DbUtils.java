...
import cn.ly.dbutils.db.table.DbModel;
import cn.ly.dbutils.db.table.Id;
import cn.ly.dbutils.db.table.Table;
import cn.ly.dbutils.db.table.TableUtils;
import cn.ly.dbutils.exception.DbException;
import cn.ly.dbutils.util.IOUtils;
...
public class DbUtils {
    ...
    public void replace(Object entity) throws DbException {
        try {
            ...
            createTableIfNotExist(entity.getClass());
            execNonQuery(cn.ly.dbutils.db.sqlite.SqlInfoBuilder.buildReplaceSqlInfo(this, entity));
    ...
    public void save(Object entity) throws DbException {
        try {
            ...
            createTableIfNotExist(entity.getClass());
            execNonQuery(cn.ly.dbutils.db.sqlite.SqlInfoBuilder.buildInsertSqlInfo(this, entity));
    ...
    public void deleteById(Class<?> entityType, Object idValue) throws DbException {
        ...
        try {
            ...
            execNonQuery(cn.ly.dbutils.db.sqlite.SqlInfoBuilder.buildDeleteSqlInfo(this, entityType, idValue));
    ...
    public void delete(Object entity) throws DbException {
        ...
        try {
            ...
            execNonQuery(cn.ly.dbutils.db.sqlite.SqlInfoBuilder.buildDeleteSqlInfo(this, entity));
    ...
    public void delete(Class<?> entityType, cn.ly.dbutils.db.sqlite.WhereBuilder whereBuilder) throws DbException {
        if (!tableIsExist(entityType)) return;
        try {
            beginTransaction();

            execNonQuery(cn.ly.dbutils.db.sqlite.SqlInfoBuilder.buildDeleteSqlInfo(this, entityType, whereBuilder));
    ...
    public void update(Object entity, String... updateColumnNames) throws DbException {
        ...
        try {
            ...
            execNonQuery(cn.ly.dbutils.db.sqlite.SqlInfoBuilder.buildUpdateSqlInfo(this, entity, updateColumnNames));
    ...
    public void update(Object entity, cn.ly.dbutils.db.sqlite.WhereBuilder whereBuilder, String... updateColumnNames) throws DbException {
        if (!tableIsExist(entity.getClass())) return;
        try {
            beginTransaction();

            execNonQuery(cn.ly.dbutils.db.sqlite.SqlInfoBuilder.buildUpdateSqlInfo(this, entity, whereBuilder, updateColumnNames));
    ...
    public void updateAll(List<?> entities, cn.ly.dbutils.db.sqlite.WhereBuilder whereBuilder, String... updateColumnNames) throws DbException {
        if (entities == null || entities.size() == 0 || !tableIsExist(entities.get(0).getClass())) return;
        try {
            beginTransaction();
    ...
    public <T> T findById(Class<T> entityType, Object idValue) throws DbException {
        ...
        cn.ly.dbutils.db.sqlite.Selector selector = cn.ly.dbutils.db.sqlite.Selector.from(entityType).where(table.id.getColumnName(), "=", idValue);

        String sql = selector.limit(1).toString();
        long seq = cn.ly.dbutils.db.sqlite.CursorUtils.FindCacheSequence.getSeq();
        ...
        if (cursor != null) {
            try {
                if (cursor.moveToNext()) {
                    T entity = (T) cn.ly.dbutils.db.sqlite.CursorUtils.getEntity(this, cursor, entityType, seq);
    ...
    @SuppressWarnings("unchecked")
    public <T> T findFirst(cn.ly.dbutils.db.sqlite.Selector selector) throws DbException {
        ...
        if (cursor != null) {
            try {
                if (cursor.moveToNext()) {
                    T entity = (T) cn.ly.dbutils.db.sqlite.CursorUtils.getEntity(this, cursor, selector.getEntityType(), seq);
                    findTempCache.put(sql, entity);
                    return entity;
                }
            } catch (Throwable e) {
    ...
    public <T> T findFirst(Class<T> entityType) throws DbException {
        return findFirst(cn.ly.dbutils.db.sqlite.Selector.from(entityType));
    }

    @SuppressWarnings("unchecked")
    public <T> List<T> findAll(cn.ly.dbutils.db.sqlite.Selector selector) throws DbException {
        if (!tableIsExist(selector.getEntityType())) return null;
    ...
    public <T> List<T> findAll(Class<T> entityType) throws DbException {
        return findAll(cn.ly.dbutils.db.sqlite.Selector.from(entityType));
    }

    public DbModel findDbModelFirst(cn.ly.dbutils.db.sqlite.SqlInfo sqlInfo) throws DbException {
        Cursor cursor = execQuery(sqlInfo);
        if (cursor != null) {
            try {
                if (cursor.moveToNext()) {
                    return cn.ly.dbutils.db.sqlite.CursorUtils.getDbModel(cursor);
                }
            } catch (Throwable e) {
                throw new DbException(e);
            } finally {
    ...
    public DbModel findDbModelFirst(cn.ly.dbutils.db.sqlite.DbModelSelector selector) throws DbException {
        if (!tableIsExist(selector.getEntityType())) return null;
    ...
    public List<DbModel> findDbModelAll(cn.ly.dbutils.db.sqlite.SqlInfo sqlInfo) throws DbException {
        ...
        if (cursor != null) {
            try {
                while (cursor.moveToNext()) {
                    dbModelList.add(cn.ly.dbutils.db.sqlite.CursorUtils.getDbModel(cursor));
                }
            } catch (Throwable e) {
                throw new DbException(e);
            } finally {
    ...
    public List<DbModel> findDbModelAll(cn.ly.dbutils.db.sqlite.DbModelSelector selector) throws DbException {
        if (!tableIsExist(selector.getEntityType())) return null;
    ...
    public long count(cn.ly.dbutils.db.sqlite.Selector selector) throws DbException {
        Class<?> entityType = selector.getEntityType();
        if (!tableIsExist(entityType)) return 0;

        Table table = Table.get(this, entityType);
        cn.ly.dbutils.db.sqlite.DbModelSelector dmSelector = selector.select("count(" + table.id.getColumnName() + ") as count");
        return findDbModelFirst(dmSelector).getLong("count");
    }

    public long count(Class<?> entityType) throws DbException {
        return count(cn.ly.dbutils.db.sqlite.Selector.from(entityType));
    }
    ...
    private void saveOrUpdateWithoutTransaction(Object entity) throws DbException {
        ...
        if (id.isAutoIncrement()) {
            if (id.getColumnValue(entity) != null) {
                execNonQuery(cn.ly.dbutils.db.sqlite.SqlInfoBuilder.buildUpdateSqlInfo(this, entity));
            } else {
    ...
    public void createTableIfNotExist(Class<?> entityType) throws DbException {
        if (!tableIsExist(entityType)) {
            cn.ly.dbutils.db.sqlite.SqlInfo sqlInfo = cn.ly.dbutils.db.sqlite.SqlInfoBuilder.buildCreateTableSqlInfo(this, entityType);
    ...
    public void execNonQuery(cn.ly.dbutils.db.sqlite.SqlInfo sqlInfo) throws DbException {
    ...
    public Cursor execQuery(cn.ly.dbutils.db.sqlite.SqlInfo sqlInfo) throws DbException {
        debugSql(sqlInfo.getSql());
        try {
